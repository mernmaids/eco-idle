    ...
    const resp = (
        <div className="bg-dark-green p-3 pt-5 detail-inner">
            ...
            <div className="text-base text-left mt-5 px-5">
                ...
                <button onClick={(e) => PurchaseOrganism(organism, userOrganism)} className="border-solid rounded border-slate-900 border-2 bg-light-blue-darken-hover p-2 m-2">
                    Buy One ({organism.get("cost").toLocaleString()} O-Points)
                </button>
            </div>
        </div>
    );
