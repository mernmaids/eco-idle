...
export function Menu() {
    return html`
        <div class="float-left m-0 w-full lg:w-1/6 lg:h-full text-center bg-dark-green sidebar">
            ...
            <div class="text-2xl py-3 menu-select">sector</div>
            <div class="text-2xl py-3 menu-select">shroom shop</div>
            <div class="text-2xl py-3 menu-select">prestige</div>
            <div class="text-2xl py-3 menu-select">enviro shop</div>
            <div class="text-2xl py-3 menu-select">settings</div>
        </div>
    `;
}